package com.example.foodrecommendation.view.category;
...
import com.example.foodrecommendation.adapter.RecyclerViewMealByCategory;
...
public class CategoryFragment extends Fragment implements CategoryView {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            presenter.getMealByCategory(requireContext(), getArguments().getString("EXTRA_DATA_NAME"));
        }
    }
